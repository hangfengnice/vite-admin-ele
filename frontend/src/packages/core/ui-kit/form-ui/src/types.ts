...
import type { SUIButtonProps } from '@/packages/core/ui-kit/shadcn-ui'
import type { ClassType, MaybeComputedRef } from '@/packages/core/base/typings'
...
export interface ActionButtonOptions extends SUIButtonProps {
  [key: string]: any
