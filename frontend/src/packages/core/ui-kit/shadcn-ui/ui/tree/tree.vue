...
import type { ClassType, Recordable } from '@/packages/core/base/typings'

import type { TreeProps } from './types'

import { onMounted, ref, watchEffect } from 'vue'

import { ChevronRight, IconifyIcon } from '@/packages/icons'
...
<template>
  <TreeRoot
    ...
    :class="
      cn(
        'text-blackA11 container  list-none rounded-lg text-sm font-medium',
