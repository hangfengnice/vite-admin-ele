...
import type { TabDefinition } from '@/packages/core/base/typings'

import type { TabConfig, TabsProps } from '../../types'

import { computed } from 'vue'

import { Pin, X } from '@/packages/core/base/icons/src'
import { VbenContextMenu, VbenIcon } from '@/packages/core/ui-kit/shadcn-ui'
  ...
  >
    <TransitionGroup name="slide-left">
      <div
        ...
        :data-index="i"
        class="tab-item translate-all group relative flex cursor-pointer [&:not(.is-active)]:hover:bg-accent"
        data-tab-item="true"
