...
import type { CaptchaPoint } from '@/packages/effects/common-ui/src'

import { reactive, ref } from 'vue'

import { Page, PointSelectionCaptcha } from '@/packages/effects/common-ui/src'

import { Card, Input, InputNumber, message, Switch } from 'element-plus'
